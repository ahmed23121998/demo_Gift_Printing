...
import { Package, Plus, CreditCard as Edit, Trash2, Eye, EyeOff, LogOut, Search, Filter } from 'lucide-react';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  const handleAddProduct = (e: React.FormEvent) => {
    ...
    const product: Product = {
      ...
      image: newProduct.image || 'https://images.pexels.com/photos/302743/pexels-photo-302743.jpeg',
      active: true,
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <p className="text-sm font-medium text-gray-600">المنتجات المفعلة</p>
